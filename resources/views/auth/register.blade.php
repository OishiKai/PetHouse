...
<div class="go-to-login">
    ...
    <a class="go-login" href="{{ route('login') }}">ログインページへ</a>
            ...
            <div class="row">
                ...
                <div class="col-35">
                    <input type="text" id="fnameA" name="kanjiFamilyName"
                        class="@error('kanjiFamilyName') is-invalid @enderror" value="{{ old('kanjiFamilyName') }}" placeholder="姓名">
                </div>
                <div class="col-35">
                    <input type="text" id="lnameA" name="kanjiFirstName"
                        class="@error('kanjiFirstName') is-invalid @enderror" value="{{ old('kanjiFirstName') }}" placeholder="氏名" />
                </div>
                <h6 class="h6-required">※全角<br />例（山田　太郎）</h6>
            </div>
            <div class="row">
                <div class="col-40">
                    <input type="text" name="kanaFamilyName" class="@error('kanaFamilyName') is-invalid @enderror" value="{{ old('kanaFamilyName') }}" placeholder="フリガナ(姓名)" />
                ...
                <div class="col-41">
                    <input type="text" name="kanaFirstName" class="@error('kanaFirstName') is-invalid @enderror" value="{{ old('kanaFirstName') }}" placeholder="フリガナ(氏名)" />
                        @error('kanaFirstName')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
